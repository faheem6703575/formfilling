...
def main8(data_file_path):
    """Main function with hardcoded input/output paths for testing"""
    try:
       
        # r"C:\Users\USER\Documents\eu excel form\excel form filling\input\tab8.txt"
        excel_template = "code/agents/ENGLISH_1A_priedas_InoStartas_en/tab8/input8.xlsx"
        output_file = "code/agents/ENGLISH_1A_priedas_InoStartas_en/tab8/8.xlsx"
        prompt_file = "code/prompts/8.txt"
