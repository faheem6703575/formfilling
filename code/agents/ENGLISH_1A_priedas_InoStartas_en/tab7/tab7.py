...
def main7(data_file_path):
    """Main function with hardcoded input/output paths for testing"""
    try:
       
        # r"C:\Users\USER\Documents\eu excel form\excel form filling\input\tab7.txt"
        excel_template = "code/agents/ENGLISH_1A_priedas_InoStartas_en/tab7/input7.xlsx"
        output_file = "code/agents/ENGLISH_1A_priedas_InoStartas_en/tab7/7.xlsx"
        prompt_file = "code/prompts/7.txt"
