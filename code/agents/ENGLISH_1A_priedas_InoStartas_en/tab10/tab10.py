...
def main10(data_file_path):
    """Main function with hardcoded input/output paths for testing"""
    try:
     
        excel_template = "code/agents/ENGLISH_1A_priedas_InoStartas_en/tab10/input10.xlsx"
        output_file = "code/agents/ENGLISH_1A_priedas_InoStartas_en/tab10/10.xlsx"
        prompt_file = "code/prompts/10.txt"
