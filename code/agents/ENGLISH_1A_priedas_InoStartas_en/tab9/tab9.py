...
def main9(data_file_path):
    """Main function with hardcoded input/output paths for testing"""
    try:
        
        # r"C:\Users\USER\Documents\eu excel form\excel form filling\input\tab9.txt"
        excel_template = "code/agents/ENGLISH_1A_priedas_InoStartas_en/tab9/input9.xlsx"
        output_file = "code/agents/ENGLISH_1A_priedas_InoStartas_en/tab9/9.xlsx"
        prompt_file = "code/prompts/9.txt"
